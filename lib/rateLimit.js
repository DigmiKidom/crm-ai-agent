...
const LIMIT_CONFIG = {
  ...
  // Public survey submissions. Looser than pageReport because a genuine burst
  // is plausible — a business sends one link to forty customers at once and
  // several answer from the same office or cafe NAT — but tight enough that
  // the endpoint can't be used to fill a tenant's feedback list with noise.
  surveyResponse: { requests: 10, window: "10 m" },
};
